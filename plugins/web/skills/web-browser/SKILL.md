---
name: web-browser
description: "Interact with web pages by clicking buttons, filling out forms, and navigating links. Works by remote-controlling Google Chrome or Chromium browsers using the Chrome DevTools Protocol (CDP). Use when an agent needs to browse the web."
license: MIT
metadata:
