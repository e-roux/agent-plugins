...
- [Make Targets for Web Projects](#make-targets-for-web-projects)
- [CSS Custom Properties](#css-custom-properties)
  - [Three-Tier Variable Hierarchy](#three-tier-variable-hierarchy)
- [Component Architecture](#component-architecture)
  - [Directory Structure](#directory-structure)
  - [Component Placement Rules](#component-placement-rules)
...
- [Performance Patterns](#performance-patterns)
  ...
  - [Bundle Awareness](#bundle-awareness)
- [Framework Configuration](#framework-configuration)
  - [SvelteKit](#sveltekit)
  - [Static vs Server](#static-vs-server)
  - [TypeScript](#typescript)
- [Design System Integration Pattern](#design-system-integration-pattern)
  - [Container-Child Consistency](#container-child-consistency)
