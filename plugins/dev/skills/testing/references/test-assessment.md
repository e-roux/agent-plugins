...
- [Assessment Is Part of Testing](#assessment-is-part-of-testing)
- [What Good Tests Demonstrate](#what-good-tests-demonstrate)
- [When To Use LLM-as-a-Judge](#when-to-use-llm-as-a-judge)
- [Inputs for the Judge](#inputs-for-the-judge)
- [Portable Prompt Shape](#portable-prompt-shape)
- [Judge Limitations and Mitigations](#judge-limitations-and-mitigations)
- [Language-Specific Evidence Examples](#language-specific-evidence-examples)
