...
- [Standard Error Format](#standard-error-format)
  ...
  - [Extended Error Response](#extended-error-response)
- [Error Categories](#error-categories)
  - [1. Validation Errors (400 Bad Request)](#1-validation-errors-400-bad-request)
  - [2. Authentication Errors (401 Unauthorized)](#2-authentication-errors-401-unauthorized)
  - [3. Authorization Errors (403 Forbidden)](#3-authorization-errors-403-forbidden)
  - [4. Not Found Errors (404 Not Found)](#4-not-found-errors-404-not-found)
  - [5. Conflict Errors (409 Conflict)](#5-conflict-errors-409-conflict)
  - [6. Rate Limiting (429 Too Many Requests)](#6-rate-limiting-429-too-many-requests)
  - [7. Server Errors (500 Internal Server Error)](#7-server-errors-500-internal-server-error)
  - [8. Service Unavailable (503 Service Unavailable)](#8-service-unavailable-503-service-unavailable)
