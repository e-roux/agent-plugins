...
- [Pagination Strategies](#pagination-strategies)
  ...
  - [4. Keyset Pagination](#4-keyset-pagination)
  - [5. Seek Pagination (Time-Based)](#5-seek-pagination-time-based)
- [Default Limits](#default-limits)
- [Response Format](#response-format)
  - [Standard Pagination Object](#standard-pagination-object)
  - [Link Header (RFC 5988)](#link-header-rfc-5988)
  - [Embedded Links](#embedded-links)
- [Sorting with Pagination](#sorting-with-pagination)
- [Filtering with Pagination](#filtering-with-pagination)
- [Total Count](#total-count)
  - [Include Total Count](#include-total-count)
  - [Omit Total Count](#omit-total-count)
  - [Optional Total Count](#optional-total-count)
