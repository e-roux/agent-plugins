...
- [Version Format](#version-format)
  - [Major Versions Only](#major-versions-only)
  - [Date-Based Versions](#date-based-versions)
- [Version Lifecycle](#version-lifecycle)
  - [1. Introduction Phase](#1-introduction-phase)
  - [2. Deprecation Phase](#2-deprecation-phase)
  - [3. Sunset Phase](#3-sunset-phase)
- [Deprecation Policy](#deprecation-policy)
  - [Recommended Timeline](#recommended-timeline)
  - [Communication Channels](#communication-channels)
- [Migration Strategy](#migration-strategy)
  - [Provide Migration Guide](#provide-migration-guide)
  - [Offer Tools](#offer-tools)
- [Version Discovery](#version-discovery)
  - [Root Endpoint](#root-endpoint)
  - [Version Info Endpoint](#version-info-endpoint)
- [OpenAPI Versioning](#openapi-versioning)
  - [Separate Specs per Version](#separate-specs-per-version)
  - [Single Spec with Servers](#single-spec-with-servers)
